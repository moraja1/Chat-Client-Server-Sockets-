...
@NamedQueries({
        ...
        @NamedQuery(name = "User.findByUsernameOrLike", query = "select u from User u where u.username = :username or upper(u.username) like upper(:username) or upper(u.username) like upper(concat(:username, '%')) or upper(u.username) like upper(concat('%', :username)) or upper(u.username) like upper(concat('%', :username, '%'))")
})
public class User {
